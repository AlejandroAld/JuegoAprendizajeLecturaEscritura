...
android {
    namespace = "com.example.juegoaprendizajelecturaescritura"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.example.juegoaprendizajelecturaescritura"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation("androidx.compose.ui:ui-tooling:1.6.0-alpha06")
